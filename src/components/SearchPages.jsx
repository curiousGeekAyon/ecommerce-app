...
return (
    pages.length > 0 ? (
      <div className="page-wrapper">
        {sPage + 1 > 1 ? <span onClick={moveBkwrd}><ArrowBackIosNewSharpIcon fontSize="large" /></span> : null}
        ...
        {sPage + 1 < val ? <ArrowForwardIosSharpIcon fontSize="large" onClick={moveFwrd} /> : null}
      </div>
    ) : null
  );
    }
